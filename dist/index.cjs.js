...
function log() {
    ...
    console.log.apply(console, __spreadArray([chalk__default["default"].bgMagenta('[vite-plugin-ossplus]:')], args, false)); // eslint-disable-line
}
function warn() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
    ...
    console.warn.apply(console, __spreadArray([chalk__default["default"].bgMagenta('[vite-plugin-ossplus]:')], args, false)); // eslint-disable-line
}
var defaultConfig = {
    provider: {},
    retry: 3,
        ...
        for (var i = 0; i < sourceFiles.length; i++) {
            ...
            if ((_b = this.config.include) === null || _b === void 0 ? void 0 : _b.test(fileName)) {
                matched.push({
                    ...
                    content: fs.readFileSync(resolveFilePath, { encoding: null }),
                });
            }
        }
        return matched;
    ...
    ViteOSSPlusPluginCore.prototype.batchUploadFiles = function (files) {
        ...
        return Promise.all(lodash.map(files, function (file) {
            ...
            if (path__default["default"].sep === '/') {
                ...
                // Windows 路径进行处理
                uploadName = path__default["default"]
        ...
        closeBundle: function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            outDirPath = vite.normalizePath(path.resolve(vite.normalizePath(buildConfig.outDir)));
                            return [4 /*yield*/, glob__default["default"].sync("".concat(outDirPath, "/**/*"), {
                                    nodir: true,
                                    dot: true,
                                })];
                        case 1:
...
exports.ViteOSSPlusPluginCore = ViteOSSPlusPluginCore;
exports["default"] = ViteOSSPlusPlugin;
